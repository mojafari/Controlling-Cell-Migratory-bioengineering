...
figure
subplot(2,2,1)
shadedErrorBar(1:5:24*5, dir_avg(1,bb:end), errbar1, 'lineprops', '-b');
hold on
plot(1:5:24*5,dir_avg(1,bb:end),':b','linewidth',2)
plot(1:5:24*5,av_01(1,bb:end),'--b','linewidth',2)

shadedErrorBar(1:5:24*5, dir_avg(2,bb:end), errbar2, 'lineprops', '-r');
plot(1:5:24*5,dir_avg(2,bb:end),':r','linewidth',2)
plot(1:5:24*5,av_01(2,bb:end),'--r','linewidth',2)

shadedErrorBar(1:5:24*5, dir_avg(3,bb:end), errbar3, 'lineprops', '-g');
plot(1:5:24*5,dir_avg(3,bb:end),':g','linewidth',2)
plot(1:5:24*5,av_01(3,bb:end),'--g','linewidth',2)

shadedErrorBar(1:5:24*5, dir_avg(4,bb:end), errbar4, 'lineprops', '-c');
plot(1:5:24*5,dir_avg(4,bb:end),':c','linewidth',2)
plot(1:5:24*5,av_01(4,bb:end),'--c','linewidth',2)

shadedErrorBar(1:5:24*5, dir_avg(5,bb:end), errbar5, 'lineprops', '-m');
plot(1:5:24*5,dir_avg(5,bb:end),':m','linewidth',2)
plot(1:5:24*5,av_01(5,bb:end),'--m','linewidth',2)
xlabel('Time (min)')
