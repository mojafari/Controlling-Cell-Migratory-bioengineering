...
x_lim_closeup = [750 2200];

figure(100)
subplot(2,3,1)
plot(ref_new_Normal,'-b','linewidth',2)
hold on
plot(log_d_new_Normal(1,:),'-r','linewidth',2)
hold off
title('System Output');
...
subplot(2,3,2)
plot(up_new_Normal,'-m','linewidth',2)
hold on
...
subplot(2,3,3)
plot((log_d_new_Normal(1,:)-ref_new_Normal)./ref_new_Normal,'-c','linewidth',2)
...
plot(ref_new_Normal,'-b','linewidth',2)
hold on
plot(log_d_OG_Normal(1,:),'-r','linewidth',2)
hold off
title('System Output');
...
subplot(2,3,5)
plot(up_OG_Normal,'-m','linewidth',2)
hold on
yline(-4,'--k','Min','LabelHorizontalAlignment','left','LabelVerticalAlignment','bottom')
yline(4,'--k','Max','LabelHorizontalAlignment','right','LabelVerticalAlignment','top')
hold off
...
subplot(2,3,6)
plot((log_d_OG_Normal(1,:)-ref_new_Normal)./ref_new_Normal,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
STEP_Improve_Normal_Sec = (STEP_OG_Normal.RiseTime-STEP_new_Normal.RiseTime)
...
figure(9100)
subplot(2,3,1)
plot(ref_SMC_Normal,'-b','linewidth',2)
hold on
plot(log_d_SMC_Normal(1,:),'-r','linewidth',2)
hold off
title('System Output');
...
subplot(2,3,2)
plot(up_SMC_Normal,'-m','linewidth',2)
hold on
yline(-4,'--k','Min','LabelHorizontalAlignment','left','LabelVerticalAlignment','bottom')
yline(4,'--k','Max','LabelHorizontalAlignment','right','LabelVerticalAlignment','top')
hold off
...
subplot(2,3,3)
plot((log_d_SMC_Normal(1,:)-ref_SMC_Normal)./ref_SMC_Normal,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
subplot(2,3,4)
plot(ref_PID_Normal,'-b','linewidth',2)
hold on
plot(log_d_PID_Normal(1,:),'-r','linewidth',2)
hold off
title('System Output');
...
subplot(2,3,5)
plot(up_PID_Normal,'-m','linewidth',2)
hold on
yline(-4,'--k','Min','LabelHorizontalAlignment','left','LabelVerticalAlignment','bottom')
yline(4,'--k','Max','LabelHorizontalAlignment','right','LabelVerticalAlignment','top')
hold off
...
subplot(2,3,6)
plot((log_d_PID_Normal(1,:)-ref_PID_Normal)./ref_PID_Normal,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
load("New_SL.mat");
figure(1011)
plot(up_new_SL,'-m','linewidth',2)
hold on
yline([-4 4],'--k',{'Min','Max'})
hold off
title('Control Output | Close Up')
xlabel('Time (sec)')
ylabel('Electric Field (V/cm)')
xlim(x_lim_closeup)
ylim(y_lim_CTRL11)
...
figure(101)
subplot(2,3,1)
plot(ref_new_SL,'-b','linewidth',2)
hold on
plot(log_d_new_SL(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','ML(NEW)','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,3)
plot((log_d_new_SL(1,:)-ref_new_SL)./ref_new_SL,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
plot(ref_new_SL,'-b','linewidth',2)
hold on
plot(log_d_OG_SL(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','ML(Old)','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,6)
plot((log_d_OG_SL(1,:)-ref_new_SL)./ref_new_SL,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
STEP_Improve_SL_Sec = (STEP_OG_SL.RiseTime-STEP_new_SL.RiseTime)
...
figure(9101)
subplot(2,3,1)
plot(ref_SMC_SL,'-b','linewidth',2)
hold on
plot(log_d_SMC_SL(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','SMC','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,3)
plot((log_d_SMC_SL(1,:)-ref_SMC_SL)./ref_SMC_SL,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
subplot(2,3,4)
plot(ref_PID_SL,'-b','linewidth',2)
hold on
plot(log_d_PID_SL(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','PID','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,6)
plot((log_d_PID_SL(1,:)-ref_PID_SL)./ref_PID_SL,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
figure(102)
subplot(2,3,1)
plot(ref_new_CH,'-b','linewidth',2)
hold on
plot(log_d_new_CH(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','ML(New)','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,3)
plot((log_d_new_CH(1,:)-ref_new_CH)./ref_new_CH,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
plot(ref_new_CH,'-b','linewidth',2)
hold on
plot(log_d_OG_CH(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','ML(Old)','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,6)
plot((log_d_OG_CH(1,:)-ref_new_CH)./ref_new_CH,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
STEP_Improve_CH_Sec = (STEP_OG_CH.RiseTime-STEP_new_CH.RiseTime)
...
figure(9102)
subplot(2,3,1)
plot(ref_SMC_CH,'-b','linewidth',2)
hold on
plot(log_d_SMC_CH(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','SMC','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,3)
plot((log_d_SMC_CH(1,:)-ref_SMC_CH)./ref_SMC_CH,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
...
subplot(2,3,4)
plot(ref_PID_CH,'-b','linewidth',2)
hold on
plot(log_d_PID_CH(1,:),'-r','linewidth',2)
hold off
title('System Output');
legend('Reference','PID','Location','northeast')
xlabel('Time (sec)')
...
subplot(2,3,6)
plot((log_d_PID_CH(1,:)-ref_PID_CH)./ref_PID_CH,'-c','linewidth',2)
title('Relative Tracking Error');
xlabel('Time (sec)')
ylabel('Relative Tracking Error');
xlim([0 4100])
